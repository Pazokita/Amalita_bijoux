        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 order-md-1">
                    <form action="{{route('commande_store_adresse')}}" method="post" id="formulaire_adresse">
                        @csrf
                        @if($errors->any())
                        ...
                        <hr class="mb-4">
                        <button id="bouton_payer" class="btn btn-outline-dark btn-lg btn-block" type="submit" >Procéder au paiement
                        </button>
                    </form>
                </div>
            </div>
